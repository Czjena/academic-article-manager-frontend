        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">Zgłaszanie artykułów</CardTitle>
                <CardDescription className="text-gray-400">
                  Przesyłaj swoje prace naukowe
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    ...
                    Obsługa formatów: PDF, LaTeX, DOCX
                  </li>
                  <li className="flex items-center">
                    <span className="w-2 h-2 rounded-full bg-blue-400 mr-2"></span>
                  ...
                  <li className="flex items-center">
                    <span className="w-2 h-2 rounded-full bg-blue-400 mr-2"></span>
                    Możliwość edycji przed recenzją
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">Proces recenzji</CardTitle>
                <CardDescription className="text-gray-400">
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">Publikacja</CardTitle>
                <CardDescription className="text-gray-400">
            ...
            {recentArticles.map((article) => (
              <Card key={article.id} className="bg-gray-700 border-gray-600">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <span
                      className={`px-2 py-1 rounded text-xs ${
                        article.status === 'opublikowany'
                          ? 'bg-green-900 text-green-300'
                          : article.status === 'w recenzji'
                ...
                <CardFooter>
                  <Button
                    variant="outline"
                    className="text-black border-gray-500 hover:bg-gray-600 w-full"
                    asChild
                  >
                  </Button>
                </CardFooter>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Platforma do zgłaszania i recenzowania prac naukowych
              </p>
            </div>
